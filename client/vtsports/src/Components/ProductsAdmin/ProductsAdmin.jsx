...
const ProductsAdmin = () => {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await axios.delete(`https://nearby-gilberta-vtsports-7339cb89.koyeb.app/products/${id}`);
        Swal.fire({
          title: "Borrado!",
  ...
  const handleRestore = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await axios.put(`https://nearby-gilberta-vtsports-7339cb89.koyeb.app/products/${id}`);
        Swal.fire({
          title: "Restaurado!",
